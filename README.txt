# ONOENDI
GPS Tracker Arduino Based, this is normally Geo Location until now there is no special function. Built from shield by shield but not using GSM shield, I mean this is alternative that we have:
